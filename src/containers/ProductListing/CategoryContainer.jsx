...
import { fetchProductListingData } from '../../actions/products';
...
class CategoryContainer extends React.Component {
  ...
  componentDidMount() {
    ...
    //this.props.location.state.catDescription
    //this.props.fetchHCData();
    //this.props.getProductListing({   
      //store_id: this.props.storeId === '' ? 1 : this.props.storeId,
      //currency_code:'USD',
     // paage_no: 1,       
     // api_token: this.props.apiToken === '' ? '7069a92e71dfe2b0b4733b290c02c66f' : this.props.apiToken,
  ...
  render() {
    ...
    return (
       <div>
                ...
                { this.props.location.state.catImage !== undefined && this.props.location.state.catImage !== '' && this.props.location.state.catImage !== null ?
               <div className="row greenToBlueImage" style={{backgroundImage: `url(${this.props.location.state.catImage})`}}>
                ...
                <div className="divider">
                    <center>{this.props.location.state.catName}&nbsp;</center>
                  </div>
                  <br/><br/>
                  {this.props.location.state.catDescription !== '' && this.props.location.state.catDescription !== null && this.props.location.state.catDescription !== undefined ?
                  <div class="row">
                        <div className="col-sm-2">

                        </div>
                        <div className="col-sm-8" style={{boxShadow: '0 4px 8px 0 rgba(0,0,0,0.2)', transition: '0.3s',padding:'30px'}}>
                        {this.props.location.state.catDescription.split("\n").map((i,key) => {
...
const mapDispatchToProps = dispatch => ({
  fetchHCData: () => dispatch(fetchAllHCData()),
  getProductListing: data => dispatch(fetchProductListingData(data)),
});

const mapStateToProps = (state) => {
  const {
    loginReducer , buyMedicineReducer , productDetailReducer
  } = state;
