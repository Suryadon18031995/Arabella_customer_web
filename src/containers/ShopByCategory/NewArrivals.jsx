...
class NewArrivalsContainer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      unitQty: {},
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (!_isEmpty(nextProps.bkmSearchData)) {
      if (JSON.stringify(_get(nextProps.bkmSearchData, 'products.result', {})) !== JSON.stringify(this.state.prevBkmData)) {
        ...
        let farmInfo;
        let temp = {};
        document.title = _get(nextProps.bkmSearchData, 'products.page_title') ? _get(nextProps.bkmSearchData, 'products.page_title') : 'Wholesale New Arrival Flowers for Sale | Bulk New Arrival Flowers';
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(ErrorHandler(NewArrivalsContainer));
