...
class FloralSuppliesContainer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      unitQty: {},
  ...
  UNSAFE_componentWillMount() {
    ...
    let pageName;
    switch (pageType) {
      case 'floral-supplies.html': pageType = 'floral_supplies';
        pageName = 'Floral Supplies';
        break;
      case 'local-delivery.html': pageType = 'local-delivery';
        pageName = 'Local Delivery';
        break;
      default: pageType = 'floral_supplies';
        pageName = 'Floral Supplies';
    }
              ...
              <ErrorBoundary>
                ...
                >
                  ...
                  <div className='shop-flowers-title'>
                    ...
                    {this.state.catDescription ? <span className='fresh-deal-description' dangerouslySetInnerHTML={this.createMarkup(this.state.catDescription)}>
                      {/* {this.state.catDescription} */}
                    </span> : null}
                  </div>
                  {/* {this.state.pageType === 'local-delivery' && <div className='local-delivery-description'>
                    <p>
                    Your favorite flowers, now in <strong>smaller box quantities</strong> available for <strong>next-day delivery</strong> at <strong>better than wholesale prices!</strong>  Shop from Roses, Lilies, Carnations, Sunflowers, Hydrangeas, Alstroemeria, Asters, Pom pons, Fuji Mums, Stock, Gypsophila, and more.
                    </p>
                        <p>Buy any 4 or more *eighth boxes in multiples 4 shipped via Domestic FedEx and get bulk order discounts!</p>
                      <ul className='custom-dd'>
                          <li>Order 4, 8, 12, or 16 boxes of any eighth box and get $2.00 off each box at checkout</li>
                          <li>
                            Order 20 or more boxes of any eighth box in multiple of 4 and get $2.50 off each box at checkout
                          </li>
                      </ul>                 
                    <p>
                    Order by 4:00pm EST to get it delivered next day. Currently only offered in select zip codes.  If you do not see any products offered in your delivery area, please contact your sales representative or check back soon!
                    </p>
                    <p>*Eighth boxes are a specific size of the box the flowers are packed in.</p>
                </div>} */}
                  <ListingComponent
                    {...this.state}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(ErrorHandler(FloralSuppliesContainer));
