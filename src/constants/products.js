...
export const RELATED_PRODUCTS_URL = ' https://uat.mediversal.tech/index.php/api/product/RelatedProduct';
...
export const RECEIVED_UPSELL_PRODUCTS = 'RECEIVED_RELATED_PRODUCT';
