// My Order Constants
export const MY_ORDER_URL = `${process.env.APPLICATION_BFF_URL}/info/orders/list`;
...
export const RECEIVED_MY_INVOICE_SEARCH_ERROR = 'RECEIVED_MY_INVOICE_SEARCH_ERROR';
...
export const RECEIVED_OPEN_TERM_SEARCH_ERROR = 'RECEIVED_OPEN_TERM_SEARCH_ERROR';
