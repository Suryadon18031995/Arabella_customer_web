...
const mapCustomerRegisterData = data => ({
  ...
  email: _get(data, 'emailAddress'),
  telephone: _get(data, 'billingTelephone'),
  streetAddress: _get(data, 'billingStreet1'),
  city: _get(data, 'billingCity'),
  zipCode: _get(data, 'billingZip'),
  country: _get(data, 'selectValue'),
  state: _get(data, 'selectStateValue'),
  taxId: _get(data, 'vatId'),
  password: _get(data, 'password'),
  confirmPassword: _get(data, 'confirmation'),
  newsletSub: _get(data, 'subcriptionInput'),
});
