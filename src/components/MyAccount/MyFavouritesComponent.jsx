...
export default function MyFavouritesComponent(props) {
    ...
    if (props.productDetails) {
        ...
        return (
            <div className="myFvrtMainDiv">
                <div key={props.index} className="row">
                    {props.viewType === 'list' && <span className='product-img-listing cursor-click'>
                        <Link to={`/${props.thisData.url_key}.html`}>
                        ...
                        <div className="myfav-product-details">
                            <div className="col-lg-5 col-xs-12 col-sm-9 myfav-details">
                                <div className="name-rating">
                                    <h2 className="product-name cursor-click">
                                        <div title={props.thisData.name}>
                                            <Link to={`/${props.thisData.url_key}.html`}>
                                                {props.thisData.name}
                                            </Link>
                                        </div>
                                ...
                                {/* <div onClick={e =>
                                    ...
                                    props.handleRemoveMyfavourite(props.thisData.pid)
                                } >
                                    {/* <span className="glyphicon glyphicon-remove-circle"></span> */}
                                    {/* <span> X </span>
                                </div> */}
                                <div className="pdt-rating col-lg-12 col-sm-12">
                                    <div className="myfav-star-ratings">
                                        <StarRatings
                            ...
                            {!_isEmpty(props.deliveryData) &&
                                <div className="col-lg-6 col-xs-9 col-sm-12 myfav-details">
                                    ...
                                    {props.apiToken && <section className="drop-down-price">
                                        <a><h6 className="price_break-myfav">Price breakdown</h6></a>
                ...
                <div className="row">
                    <div className="col-md-6 col-sm-6">
                        <div className="dropdown-detail right col-md-12 col-lg-12" >
                            <span className="myFavMoreDtlsCls" onClick={() => props.handleMoreDetailClick(props.thisData && props.thisData.pid)}
                            >
                                More Detail <i className="fa fa-sort-down" /></span>
                        </div>
                    </div>
                    {!_isEmpty(props.moreavaildata) &&

                        <div className="col-md-6 col-sm-6">
                            <span className="myFavMoreAvlsCls" onClick={() => props.handleMoreavailclick(props.thisData && props.thisData.pid)}>
                ...
                <div className="row">
                                    ...
                                    <tbody>
                                        <tr className="list-inline moreavailable">
                                            <th>Select Appr</th>
                                            {
                                                Object.entries(props.moreavaildata).map((thisData, index) => (
                                                    ...
                                                    // <td className="myfav-prodswatch" key={index}>

                                                    //     <input type="radio" name="swatch" onClick={() => props.ProductSwatch(thisData[0], props.index)} />
                                                    // </td>
                                        ...
                                        <tr className="list-inline moreavailable">
                                            <th>Qty Per</th>
                                            {
                                                ...
                                                Object.entries(props.moreavaildata).map((thisData, index) => (
                                                    // (_get(props.moreavaildata, 'pickup_date')) = moreavaildata.slice(0, 1)
                    ...
                    <div className="col-lg-12 col-xs-12 ">
                        {_get(props.showMoreDetail, _get(props.thisData, 'pid'), false) && <div>
                            <span style={{}} />
